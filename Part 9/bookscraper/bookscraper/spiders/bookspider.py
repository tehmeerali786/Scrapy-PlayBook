...
class BookspiderSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for book in books:
            retlative_url = book.css('h3 a').attrib['href']
            if 'catalogue/' in retlative_url:
                book_url = 'https://books.toscrape.com/' + retlative_url
            else: 
                book_url = 'https://books.toscrape.com/catalogue/' + retlative_url
    ...
    def parse_book_page(self, response):
        ...
        book_item['stars'] = book.css("p.star-rating").get()
